...
public class GameStart extends Frame
{
	...
	public void paint(Graphics g)
	{
		...
		case 1:
			...
			//g.drawString("子弹集合数目：" + mslist1.size(), 30, 120);
			myPlane.drawMe(g);
			bldMe.drawMe(g);
	...
	public void getEmp()
	{
		...
		{
			EmpPlane emp = new EmpPlane(e_x, random.nextInt(570)+5, true, Direction.L, 300, this);
			emplist.add(emp);
		}
	}
