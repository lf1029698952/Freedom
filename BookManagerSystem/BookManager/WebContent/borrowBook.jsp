...
<body>
	<div class="div" align="center">
				<h3 style="color:red"><a href="borrowed">已借图书</a></h3>
			...
			<div>
					<a href="borrowed?page=1">第一页</a>&nbsp;&nbsp;|&nbsp;
				<c:if test="${page <= 1}">
					<a href="borrowed?page=${page + 1}">下一页</a>&nbsp;&nbsp;|&nbsp;
				</c:if>
				<c:if test="${page > 1}">
					<a href="borrowed?page=${page - 1}">上一页</a>&nbsp;&nbsp;|&nbsp;
				</c:if>
				<c:if test="${page < totalPage && page > 1}">
					<a href="borrowed?page=${page + 1}">下一页</a>&nbsp;&nbsp;|&nbsp;
				</c:if>
					<a href="borrowed?page=${totalPage}">最后一页</a>
			</div>
	</div>
</body>
</html>